...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/proteng-conductor/artifact/{bucketName}/{objectName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/proteng-conductor/jobs": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter state of the jobs",
                        "name": "state",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateJobInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/proteng-conductor/mutations/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "models.CopyQueryResultInput": {
            ...
            "properties": {
                ...
                "result": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CopyResultInput"
                    }
                },
                "run_id": {
                    "type": "integer"
